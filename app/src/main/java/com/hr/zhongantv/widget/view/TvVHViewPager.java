package com.hr.zhongantv.widget.view;
...
import com.hr.zhongantv.widget.view.vhpager.YViewPager;

import java.lang.reflect.Field;

/**
 * Created by 吕 on 2018/6/7.
 */

public class TvVHViewPager extends YViewPager {

    private FixedSpeedScroller mScroller;

    public TvVHViewPager(Context context) {
        this(context, null);
    }

    public TvVHViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
